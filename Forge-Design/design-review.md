...
description: >
  Use this skill whenever Akhilkumar wants a design review of Reltio screens or flows. Trigger on phrases like "review this design", "critique these screens", "give me feedback on this flow", "review my Figma", "what do you think of these designs", or any time a Figma link is shared alongside a request for feedback or critique. Also trigger when the user pastes a Figma URL even without an explicit review request — if there's a Figma link in the message, assume a review is wanted. This skill produces high-quality, structured Figma comments pinned to relevant frames, grounded in Reltio platform conventions, UX heuristics, and fresh product documentation. Always use this skill — even for quick or narrow review requests — to ensure consistent, thorough output.
---

# Reltio Design Reviewer

Reviews Reltio UX designs from Figma and posts structured, severity-labeled comments directly back to the file. Grounds all feedback in fresh Reltio documentation, platform conventions, and UX heuristics.
